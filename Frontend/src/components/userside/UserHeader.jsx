...
import prime from "../../assets/s-logo.png";
import '../../assets/Styles/navlogin.scss'
...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="flex flex-wrap justify-between items-center py-4 bg-white backdrop-blur-md shadow-md w-full relative z-10 px-10">
        {/* Logo Container */}
